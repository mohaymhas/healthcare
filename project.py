...
def load_data():
 ...
 #Load data
    ...
    df['Week of Year'] = df['Date of Visit'].dt.isocalendar().week.astype(int)
...
if page == "🏠 Overview":
    ...
    st.markdown("### General Analysis of Patients sources")
   #for card color 
    st.markdown("""
<style>
/* KPI card */
...
""", unsafe_allow_html=True)
    ...
    with tab4:
        ...
        df_merged_geo = pd.merge(filtered_df, cities_coordinates_df, on='City', how='left')
